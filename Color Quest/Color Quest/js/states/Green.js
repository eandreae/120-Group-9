// Green color state
var Green = function(game) {};
Green.prototype = {

   // Variables used in Green
   init: function() {

   },

   preload: function() {
      console.log('Green: preload');

      game.load.tilemap('layout', 'assets/TileMaps/GreenMap.json', null, Phaser.Tilemap.TILED_JSON);
